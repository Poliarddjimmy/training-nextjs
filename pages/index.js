              ...
              <div className="sidebar_position_right">
                ...
                <div className="stm_archive_product_inner_grid_content">
                  <ul className="stm-courses row list-unstyled">
                    ...
                    <div className="stm_woo_archive_view_type_list">
                      <li
                        className="col-md-12 course-col-list post-488 product type-product status-publish has-post-thumbnail product_cat-cinema product_cat-films product_cat-logical-thinking last instock featured shipping-taxable purchasable product-type-simple">
                        <a href="https://stylemixthemes.com/masterstudy/ms/courses/photography-for-beginners/"
                          className="trainingp-link training__link"></a>
                        <div className="stm_archive_product_inner_unit heading_font"><a
                          href="https://stylemixthemes.com/masterstudy/ms/courses/photography-for-beginners/"
                          className="trainingp-link training__link"></a>
                          <div className="stm_archive_product_inner_unit_centered clearfix"><a
                            href="https://stylemixthemes.com/masterstudy/ms/courses/photography-for-beginners/"
                            className="trainingp-link training__link"></a>
                            <div className="stm_featured_product_image_list"><a
                              href="https://stylemixthemes.com/masterstudy/ms/courses/photography-for-beginners/"
                              ...
                              <div className="stm_featured_product_price">
                                <div className="price">
                                  <h5><span
                                    className="woocommerce-Price-amount amount"><bdi><span
                                      className="woocommerce-Price-currencySymbol">$</span>759.00</bdi></span>
                                  </h5>
                                </div>
                              </div>
                            </a><a
                              href="https://stylemixthemes.com/masterstudy/ms/courses/photography-for-beginners/"
                              title="View course - Photography for Beginners Masterclass">
                                <img width="300" height="225"
                                  src="./list_files/Photography-for-Beginners-300x225.jpg"
                                  className="img-responsive wp-post-image" alt=""
                                  loading="lazy" /> </a></div>
                            <div className="stm_products_archive_body_list">
                              <h2 className="title"> Photography for Beginners Masterclass <span
                                className="product_status h5 new"> New </span></h2>
                              <div className="clearfix stm_product_meta_unit">
                                <div className="clearfix"></div>
                                <div className="pull-left"> <a className="expert_unit_link"
                                  href="https://stylemixthemes.com/masterstudy/ms/teachers/rebeca-adams/">
                                  <div className="expert_unit">
                                    <div className="expert_img"> <img
                                      className="img-responsive"
                                      src="./list_files/techer_f-75x75.jpg" />
                                    </div>
                                    <div className="expert h6">
                                      <div className="value">Rebeca Adams</div>
                                      <span>Teacher</span>
                                    </div>
                                  </div>
                                </a></div>
                                <div className="pull-right sm-xs-pull-left">
                                  <div className="stm_featured_product_stock"> <i
                                    className="fa-icon-stm_icon_users"></i> <span
                                      className="h6">69 Available <br />seats</span></div>
                                </div>
                              </div>
                              <div className="stm_archive_product_exceprt normal_font">
                                <p>In Vedic Sanskrit, the more commonly used, literal
                                meaning of the Sanskrit word yoga which is “to add”, “to
                                join”, “to unite”, or “to attach” from the root yuj,
                                already had a much more figurative sense, where the
                                                        yoking or harnessing of oxen …</p>
                              </div>
                              <div className="see_more h5"> <a
                                href="https://stylemixthemes.com/masterstudy/ms/courses/photography-for-beginners/">See
                                                        more</a></div>
                            </div>
                          </div>
                          <div className="multiseparator"></div>
